 ...
 * @LastEditTime: 2023-05-23 06:26:26
    ...
    async execute(interaction) {
        ...
        data.choices.forEach(async (u, index) => {
            ...
            if ((Option_Time === false || choices_hour === Option_Time) &&
                (Option_User === interaction.user || choices_name_id === Option_User.id) &&
                ((Option_Channel === null || (choices_channel_get_id === 'undefined' && choices_channel === Option_Channel.id)) || (choices_channel_get_id !== 'undefined' && choices_channel === Option_Channel.id)) &&
