 ...
 * @LastEditTime: 2023-05-23 07:56:45
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        for (let i = 0; i < Chose_Date.length; i++) {
            ...
            const paddedHour = Chose_Date[i].choices_hour.toString().padStart(2, "0");
            const paddedMinute = Chose_Date[i].choices_minute.toString().padStart(2, "0");
            const Chose_Date_Time = Chose_Date[i].choices_year + '/' + Chose_Date[i].choices_month + '/' + Chose_Date[i].choices_day + '  ' + Chose_Date[i].choices_hour + ':' + Chose_Date[i].choices_minute;
