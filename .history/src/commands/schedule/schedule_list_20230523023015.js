 ...
 * @LastEditTime: 2023-05-23 02:30:15
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const Option_User = interaction.options.getUser('查詢使用者提醒').id ?? interaction.user.id;
        ...
        console.log(Option_Channel, Option_User, Option_String, Option_Time);
