 ...
 * @LastEditTime: 2023-05-22 05:38:14
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const day_limit = interaction.options.getNumber('刪除歷史天數') ?? null;
        const hour_limit = interaction.option.getNumber('刪除歷史小時數') ?? null;
