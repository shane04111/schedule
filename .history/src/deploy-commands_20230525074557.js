 ...
 * @LastEditTime: 2023-05-25 07:44:59
...
(async () => {
    try {
        console.log(`正在刷新 ${commands.length + guild_commands.length} 個應用程式 (/) 指令`);
        ...
        console.log(`成功重新載入 ${data.length} 個應用程式公共 (/) 命令。`);
        console.log(`成功重新載入 ${guild_data.length} 個應用程式公會 (/) 命令。`)
    } catch (error) {
